...
function TopBanner() {
    ...
    const [img,setImg] = useState("https://laptop88.vn/media/banner/12_May8c4a892a289e905ac91086cc9df01241.jpg");
    const [btnActive, setBtnActive] = useState(1);

    const listImg = ["https://laptop88.vn/media/banner/12_May8c4a892a289e905ac91086cc9df01241.jpg","https://laptop88.vn/media/banner/03_May50c92c020b8ada51c78e3e8639d6b6ef.jpg","https://laptop88.vn/media/banner/24_Apr903aaf4c7c434388fcc63c8de65fe3cc.jpg","https://laptop88.vn/media/banner/21_Apr88c6782778198b0fc8532dd08578a116.jpg","https://laptop88.vn/media/banner/15_Feb82bd0fd02e2bc45b34c97ebf787966db.jpg"]
                    ...
                    <div className="owl-stage-outer">
                        ...
                        <div className="owl-nav">
                            <div className="owl-prev">
                                <i className="fa fa-caret-left" aria-hidden="true" onClick={handleBtnPrev}></i>
                            </div> 
                    ...
                    <div className="owl-stage-outer flex">
                        <div className="owl-stage flex">
                            <div className="owl-item">
                                <div className={`item ${btnActive==1? 'item-active':null}`} onClick={(index) => {handleBanner(0);setBtnActive(1) } }>
                                    <p>Miễn phí vệ sinh, tra keo, cài Winlaptop</p>
                                </div>
                            </div>
                            <div className="owl-item">
                                <div className={`item ${btnActive==2? 'item-active':null}`} onClick={(index) => {handleBanner(1);setBtnActive(2)} }>
                                    <p>Laptop gaming Sale shock</p>
                                </div>
                            </div>
                            <div className="owl-item">
                            <div className={`item ${btnActive==3? 'item-active':null}`} onClick={(index) => {handleBanner(2);setBtnActive(3)} }>
                                    <p>Dell Vostro 3405 khoẻ nhất tầm giá 10tr</p>
                                </div>
                            </div>
                            <div className="owl-item">
                            <div className={`item ${btnActive==4? 'item-active':null}`} onClick={(index) => {handleBanner(3);setBtnActive(4)} }>
                                    <p>Gigabyte G5 RTX 3050 rẻ nhất chỉ 18 triệu</p>
                                </div>
                            </div>
                            <div className="owl-item">
                                <div className={`item ${btnActive==5? 'item-active':null}`} onClick={(index) => {handleBanner(4);setBtnActive(5)} }>
