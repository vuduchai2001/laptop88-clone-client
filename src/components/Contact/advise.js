            ...
            <div className="popup--content">
              <div className="form--advise">
                ...
                <div className="form--advise--items">
                  <input
                    type="text"
                    className="form--advise--input content--advise "
                ...
                <div className="form--check">
                  <div className="form--check--item">
                    <input
                      type="button"
                      id="btn1"
                      onClick={(id) => handleChangeBtn("btn1")}
                    ></input>
                  ...
                  <div className="form--check--item">
                    <input
                      type="button"
                      id="btn2"
                      onClick={(id) => handleChangeBtn("btn2")}
                    ></input>
                  ...
                  <div className="form--check--item">
                    <input
                      type="button"
                      id="btn3"
                      onClick={(id) => handleChangeBtn("btn3")}
                    ></input>
