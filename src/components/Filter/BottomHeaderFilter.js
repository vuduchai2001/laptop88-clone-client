      ...
      <div className="container">
        <div className="bottom--header--main flex align-item">
            ...
            <div className="menu_holder not-home">
              {navdata.map((item) => (
                <div className="item">
                  <a
                    href="#"
                    className="item-cate flex align-items space-between"
                  >
          ...
          <div className="bottom--header--right flex">
            <a
              className="bottom--header--right--item flex space-center"
              href="#"
            >
            ...
            >
              ...
              <div className="righ--item--content">
                <p>Dell Gaming G15 2022 Rẻ Nhất TT Chỉ 18 Triệu!</p>
              </div>
            </a>
            <a
              className="bottom--header--right--item flex space-center"
